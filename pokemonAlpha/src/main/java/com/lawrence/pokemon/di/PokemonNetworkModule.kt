...
import com.lawrence.pokemon.BuildConfig
import com.lawrence.pokemon.networking.PokemonService
import com.lawrence.pokemon.utils.Constants.BASE_URL
...
object PokemonNetworkModule {
    ...
    @Singleton
    @Provides
    fun providePokemonService(retrofit: Retrofit): PokemonService = retrofit
